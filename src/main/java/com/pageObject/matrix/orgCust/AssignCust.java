...
public class AssignCust extends JsonObject { //客户维护分配
    ...
    public final  String d11 = "客户维护分配-表格表头row下的th col-th";
...
//    private final  String dd2Px28t = commonObjectPopped.getXpath(commonObjectPopped.getD28P());
    ...
    private final  String t = commonObjectPopped.getStringP();

    public final  String dd1Pdd1 = "客户维护分配-客户分配-客户名称-textarea";
    private final  String xx1Pxx1 = t + commonObject.get$XQuerySelectDiv("客户名称") + "//textarea";

    public final  String dd1Pdd2 = "客户维护分配-客户分配-维护类型-div";
    private final  String xx1Pxx2 = t + commonObject.get$XQuerySelectDiv("维护类型");
    ...
    private final  String xx1Pxx3 = t + commonObject.get$XQueryInput("客户所属部门");
    ...
    private final  String xx1Pxx4 = t + commonObject.get$XQuerySelectDiv("原因") + "//textarea";


    public final  String dd1Pdd5 = "客户维护分配-客户分配-客户维护经理-input";
    private final  String xx1Pxx5 = t + commonObject.get$XQueryInput("客户维护经理");
...
//    private final  String xx1Pxx5Pxx3 = commonObjectPopped.getXpath(commonObjectPopped.getD10P());
    ...
    private final  String xx1Pxx6 = t + commonObject.get$XQueryInput("团队名称");
